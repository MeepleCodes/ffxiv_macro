...
- Changing font size doesn't redraw the selection box or update the cursor pixel coordinates properly
 ...
 * Split this out from the Konva container? Support layered or custom backgrounds?
